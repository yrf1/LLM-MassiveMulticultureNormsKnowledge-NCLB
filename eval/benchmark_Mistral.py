...
def run_eval_per_s_query(query_s, generator, max_gen_len=64, ckpt_type=""):
    ...
    s_out = generator.generate(query_s) #+" True or Fals e:")
    return s_out
...
def main(
    ...
    model = AutoModelForCausalLM.from_pretrained(ckpt_dir) #, quantization_config=bnb_config)
...
if __name__ == "__main__":
    main(ckpt_dir="mistralai/Mistral-7B-Instruct-v0.2", tokenizer_path="tokenizer.model")
